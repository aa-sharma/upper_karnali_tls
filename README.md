...
> The Upper Karnali Storage Hydropower Project is a proposed run-of-the-river hydroelectric plant on the Karnali river in West Nepal. It will have an installed capacity of 900 MW, making it the largest hydropower plant in Nepal when achieved.[1] However, most of the generated power is set to be exported to both Bangladesh (about 500 MW) and India (another 292 MW), via a 400 kV double circuit transmission line, with the only remaining 108 MW of total power dedicated to local consumption.
